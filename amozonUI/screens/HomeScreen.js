            ...
            <Container>
                <Header style={[{
                    ...
                    <Left style={{ flexDirection: "row" }}>
                        ...
                        <Icon onPress={() => this.props.navigation.openDrawer()} name="md-menu"  style={{ marginRight: 15, color: 'white' }} />
                ...
                <View style={{ position: 'absolute', left: 0, right: 0, top: 90, height: 70,
                     backgroundColor: '#3a455c',flexDirection:'row',alignItems:'center',paddingHorizontal:5 }}>
                    <TouchableOpacity>
                        <View style={{width:100,height:50,backgroundColor:"#e7e7eb",borderRadius:4,padding:10,justifyContent:'center'}}>
                            <Text style={{fontSize:12,}}>shopoing by</Text>
